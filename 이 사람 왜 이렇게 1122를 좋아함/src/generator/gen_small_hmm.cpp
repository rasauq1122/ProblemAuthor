...
int main() {
    ...
    uniform_int_distribution<long long> xgen(-100, 100);
    uniform_int_distribution<int> qgen(5, 15);
    for (int case_i = 0 ; case_i < CASE ; case_i++) {
        ...
        uniform_int_distribution<int> qqgen(0, Q);
        long long x = qqgen(seed);
